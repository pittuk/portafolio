...
export const metadata: Metadata = {
  title: 'Diseño de tiendas online con WooCommerce — Luis Cruz',
  description: 'Tiendas online construidas sobre WordPress y WooCommerce: catálogo, pagos, envíos y checkout pensados para vender, no solo para verse bien.',
